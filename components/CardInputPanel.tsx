      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-2 md:mb-3">
          <span className="text-gray-500 text-xs md:text-sm">
            → <span className="text-gray-200 font-semibold">{activeLabel}</span>
          </span>
          <button
            onClick={onUndo}
            disabled={!canUndo}
            className="text-xs px-3 py-1.5 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-300 disabled:opacity-30 disabled:cursor-not-allowed transition-colors border border-gray-700 touch-manipulation"
          >
            ↩ Undo last
          </button>
        </div>
        ...
        <div className="hidden md:flex gap-4 mt-3 justify-center text-xs">
